...
function handel_custom_images() {
  // slide é o nome, 1000 o width, 800 o height e CROP true.
  // vai centralizar e manter o topo da imagem
...
function remove_sombe_body_class($classes) {
...
add_filter('body_class', 'remove_sombe_body_class');
...
function handel_proucts_list($products) { ?>
